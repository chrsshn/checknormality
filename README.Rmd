...
## Overview
The goal of checknormality is to provide implementations of popular normality tests that returns the test statistics and p-values. As of 2020/11/30, the package contains an implementation of the [Shapiro-Wilk Test of Normality](https://en.wikipedia.org/wiki/Shapiro%E2%80%93Wilk_test).
